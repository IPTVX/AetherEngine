...
| Audio | AAC, AC3, EAC3, FLAC, ALAC stream-copy lossless; TrueHD / MLP / DTS / DTS-HD MA / MP3 / MP2 / Opus / Vorbis / LPCM (incl. Blu-ray) / WMA (Standard, Pro, Lossless, Voice) bridge to EAC3 5.1 (default) or lossless FLAC |
...
```swift
.package(url: "https://github.com/superuser404notfound/AetherEngine", from: "6.77.0")
```
...
Pin to `.upToNextMinor(from: "6.77.0")` for stricter teams that prefer to opt into minor bumps explicitly.
