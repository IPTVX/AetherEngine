...
let package = Package(
    ...
    dependencies: [
        ...
        // Pinned to the IPTVX release tag: this package ships the prebuilt
        // decode stack, so a floating version silently changes which
        ...
        // Pinned to the IPTVX release tag for the same reason as FFmpegBuild above, with a
        ...
        .package(url: "https://github.com/IPTVX/LibDovi", exact: "2.0.0-iptvx"),
    ],
    targets: [
        .target(
            name: "AetherEngine",
