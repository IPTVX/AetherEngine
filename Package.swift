...
let package = Package(
    ...
    dependencies: [
        ...
        .package(
            url: "https://github.com/IPTVX/LibDovi",
            exact: "2.1.0-iptvx"
        ),
    ],
    targets: [
